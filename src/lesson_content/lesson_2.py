...
lesson_2_timeline = {
    ...
    8: "In braille the letter A is represented by a single DOT. Dot 1 represents the letter A.",
    9: "Try it now and raise dot 1.",
    10: 33,
    11: "Fantastic. This represents the letter A in Braille.",
    12: "In braille the letter B is represented by two DOTs. When dot 1 and dot 2 are raised this represents the letter B.",
    13: "Try it now.",
    14: 8,
    15: "Nice one this is the letter B.",
    18: "The letter C is represented by 2 dots. Dot 1 and Dot 4.",
    18.5: "Try it now.",
    19: 9,
    ...
    24: "Up next is the letter E. The letter E is dot 1 and 5. Try it now.",
    25: 11,
